...
<footer id="colophon" class="site-footer">
	...
	<div class="footer-copy">
		<div class="container text-center">
			...
			<P>
				<!-- Design & Developed by <a href="https://www.linkedin.com/in/itsrashad/" target="_blank">itsRashad</a> --> <a href="#"><i class="fa-2x fas fa-arrow-square-up"></i></a> <span class="top"></span></P>
		</div>
	</div>
</footer>
